...
import com.zack.zojbackendquestionservice.mapper.QuestionListMapper;
import com.zack.zojbackendquestionservice.service.QuestionListService;
...
//        }
        ...
        List<QuestionListVO> questionVOList = questionLists.stream().map(questionList -> {
            ...
            questionListVO.setUserVO(userFeignClient.getUserVO(user));
